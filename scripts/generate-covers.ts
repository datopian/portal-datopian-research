...
async function main() {
  ...
  const covers: Record<string, CoverModule> = {
    "great-decoupling": await import("../content/stories/great-decoupling.cover"),
    "biology-got-cheap-medicine-didnt": await import(
      "../content/stories/biology-got-cheap-medicine-didnt.cover"
    ),
  };
