    ...
    <section className="py-12 border-t border-gray-100">
      <div className="custom-container mx-auto">
        <div className="flex items-start justify-between mb-6">
          <div>
            <h2 className="text-2xl font-black text-gray-900">Featured Reports</h2>
            <p className="mt-1 text-sm text-gray-500">Data-driven narratives built from the portal's research datasets.</p>
          </div>
          <Link
            href="/stories"
